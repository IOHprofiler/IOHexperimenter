...
TEST_F(BaseTest, CECfitness_dimension10)
{
    const auto file_name = ioh::common::file::utils::find_static_file("cecfitness10.in");
    std::string s;
    ...
    while (getline(infile, s))
    {
        ...
        auto problem = problem_factory.create(func_id, ins_id, 10);
        auto y = (*problem)(x);
