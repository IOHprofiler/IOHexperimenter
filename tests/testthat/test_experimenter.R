...
test_that("Initialization of experimenter",{
  ...
  expect_equal(obj_func(problem, seq(1,1,length.out = 100)), 100)
  expect_equal(obj_func(problem, seq(0,0,length.out = 100)), 0)
  unlink(attr(exper,"data.dir"))
})
