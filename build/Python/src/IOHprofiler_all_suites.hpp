...
static registerInFactory<IOHprofiler_suite<int>,PBO_suite> regPBO(std::string name = "PBO");
static registerInFactory<IOHprofiler_suite<double>,BBOB_suite> regBBOB(std::string name = "BBOB");
