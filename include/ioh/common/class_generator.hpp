...
namespace ioh {
    namespace common {
        ...
        class Factory {
             ...
             */
            std::map<std::string, std::shared_ptr<ChildType>(*)(Args &&...)>
            registry_;
        public:
            Factory() = default;
            ~Factory() = default;
             ...
             */
            void register_class(std::string id,
                                std::shared_ptr<ChildType> (*func)(
                                    Args &&...)) {
             ...
             */
            [[nodiscard]]
            std::shared_ptr<ChildType> create(std::string id,
                                              Args ... params) const {
        ...
        public:
            ...
            static std::shared_ptr<ParentType> create(Args &&... params) {
                return std::shared_ptr<ParentType>(
                    ChildType::create(std::forward<Args>(params)...));
            }
        };
    }
}
