...
namespace ioh::problem::cec2022
{
    ...
    class Rastrigin final : public CEC2022// CEC2022Problem<Rastrigin>
    {
    protected:
    ...
    public:
        ...
        Rastrigin(const int instance, const int n_variables) : CEC2022(1004, instance, n_variables, "CEC2022Rastrigin")
        {
        }
    };
}
