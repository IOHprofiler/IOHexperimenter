	...
	namespace problem
	{
		namespace transformation
		{
			namespace methods
			{
				...
				inline void transform_vars_xor(std::vector<int>& x, const int seed)
				{
				...
				inline void transform_vars_sigma(std::vector<int>& x, const int seed)
				{
				...
				inline void transform_obj_scale(std::vector<double>& y, const int seed)
				{
				...
				inline void transform_obj_shift(std::vector<double>& y, const int seed)
				{
