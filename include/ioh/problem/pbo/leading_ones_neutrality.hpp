...
namespace ioh
{
    namespace problem
    {
        namespace pbo
        {
            class LeadingOnes_Neutrality : public PBOProblem<LeadingOnes_Neutrality>
            {
            protected:
            ...
            public:
                 ...
                 **/
                LeadingOnes_Neutrality(const int instance, const int n_variables) :
                    PBOProblem(13, instance, n_variables, "LeadingOnes_Neutrality")
                {
