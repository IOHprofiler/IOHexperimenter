        ...
        namespace pbo {
            ...
            public:
                ...
                void set_n_k(const int n, const int k) {
                    ...
                    for (auto i = 0; i != n; ++i) {
                        common::Random::uniform(static_cast<size_t>(k),
                                                static_cast<long>(k * (i + 1)),
                                                rand_vec);
                        ...
                        for (auto i = n - 1; i > 0; --i) {
                            const auto randPos = static_cast<int>(floor(
                                rand_vec[n - 1 - i] * (i + 1)));
                    ...
                    for (auto i = 0; i != n; ++i) {
                        common::Random::uniform(
                            static_cast<size_t>(pow(2, k + 1)),
