        ...
        namespace pbo {
            ...
            public:
                ...
                /**
                       ...
                       **/
                LeadingOnes_Ruggedness3(int instance_id = IOH_DEFAULT_INSTANCE,
                                        int dimension = IOH_DEFAULT_DIMENSION)
                    : pbo_base(17, "LeadingOnes_Ruggedness3", instance_id, dimension) {
                ...
                static LeadingOnes_Ruggedness3 *create(
