    ...
    namespace suite {
        ...
        public:
            ...
            void register_problems() override {
                ...
                register_problem<bbob_base, Bueche_Rastrigin>(
                    "Bueche_Rastrigin", 4);
                register_problem<bbob_base, Linear_Slope>("Linear_Slope", 5);
                register_problem<bbob_base, AttractiveSector>(
                    "Attractive_Sector", 6);
                register_problem<
                    bbob_base, Step_Ellipsoid>("Step_Ellipsoid", 7);
                register_problem<bbob_base, Rosenbrock>("Rosenbrock", 8);
                register_problem<bbob_base, Rosenbrock_Rotated>(
                    "Rosenbrock_Rotated", 9);
                register_problem<bbob_base, Ellipsoid_Rotated>(
                    "Ellipsoid_Rotated", 10);
                ...
                register_problem<bbob_base, Different_Powers>(
                    "Different_Powers", 14);
                register_problem<bbob_base, Rastrigin_Rotated>(
                ...
                register_problem<bbob_base, Griewank_RosenBrock>(
                ...
                register_problem<bbob_base, Lunacek_Bi_Rastrigin>(
