    ...
    namespace suite {
        ...
        public:
            ...
            void register_problems() override {
                ...
                register_problem<pbo_base, OneMax_Neutrality>(
                    "OneMax_Neutrality", 6);
                register_problem<pbo_base, OneMax_Epistasis>(
                    "OneMax_Epistasis", 7);
                register_problem<pbo_base, OneMax_Ruggedness1>(
                    "OneMax_Ruggedness1", 8);
                register_problem<pbo_base, OneMax_Ruggedness2>(
                    "OneMax_Ruggedness2", 9);
                register_problem<pbo_base, OneMax_Ruggedness3>(
                    "OneMax_Ruggedness3", 10);
                register_problem<pbo_base, LeadingOnes_Dummy1>(
                    "LeadingOnes_Dummy1", 11);
                register_problem<pbo_base, LeadingOnes_Dummy2>(
                    "LeadingOnes_Dummy2", 12);
                register_problem<pbo_base, LeadingOnes_Neutrality>(
                    "LeadingOnes_Neutrality", 13);
                register_problem<pbo_base, LeadingOnes_Epistasis>(
                    "LeadingOnes_Epistasis", 14);
                register_problem<pbo_base, LeadingOnes_Ruggedness1>(
                    "LeadingOnes_Ruggedness1", 15);
                register_problem<pbo_base, LeadingOnes_Ruggedness2>(
                    "LeadingOnes_Ruggedness2", 16);
                register_problem<pbo_base, LeadingOnes_Ruggedness3>(
                    "LeadingOnes_Ruggedness3", 17);
                ...
                register_problem<pbo_base, Ising_Triangular>(
                    "Ising_Triangular", 21);
                register_problem<pbo_base, NQueens>("NQueens", 23);
                register_problem<pbo_base, Concatenated_Trap>(
                    "Concatenated_Trap", 24);
