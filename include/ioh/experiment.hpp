...
namespace ioh
{
    ...
    private:
        ...
        /**
         * \brief A type alias to determine if the ProblemType is single-objective or multi-objective
         */
        using Type = std::conditional_t<
            std::is_base_of_v<ioh::problem::RealSingleObjective, ProblemType> ||
            std::is_base_of_v<ioh::problem::IntegerSingleObjective, ProblemType>,
            ioh::problem::SingleObjective,
            ioh::problem::MultiObjective
        >;
        /**
         * \brief A pointer to the logger.
         */
        std::shared_ptr<Logger<Type>> logger_;
    ...
    public:
         ...
         */
        Experimenter(std::shared_ptr<suite::Suite<ProblemType>> suite, std::shared_ptr<Logger<Type>> logger,
         ...
         * \return Private 
         */
        [[nodiscard]] std::shared_ptr<Logger<Type>> logger() const { return logger_; }
