        ...
        namespace mo
        {
            ...
            namespace structures
            {
                ...
                struct RunInfo : common::HasRepr
                {
                    ...
                    //! Attributes
                    const std::vector<analyzer::structures::Attribute<double>> attributes;
                     ...
                     * @param ra Attributes
                     */
                    RunInfo(const size_t instance, const size_t evals, const ParetoFrontPoint &bp,
                            const std::vector<analyzer::structures::Attribute<double>> &ra = {}) :
                        instance(instance),
                    ...
                    {
                        return fmt::format(
                            "\"instance\": {}, \"evals\": {}, \"best\": {{{}}}{}", instance, evals, best_points,
                ...
                struct ScenarioInfo : common::HasRepr
                {
                    ...
                    std::string repr() const override
                    {
                        return fmt::format(
                            "\"dimension\": {},\n\t\t\"path\": \"{}\",\n\t\t\"runs\": [\n\t\t\t{{{}}}\n\t\t]",
                            dimension, data_file, fmt::join(runs, "},\n\t\t\t{"));
                    }
                };
                ...
                struct ExperimentInfo : common::HasRepr
                {
                    ...
                    //! Algoritm meta data
                    const analyzer::structures::AlgorithmInfo algorithm;
                    //! Attributes
                    const std::vector<analyzer::structures::Attribute<std::string>> attributes;
                    //! Run attributes
                    ...
                    std::string repr() const override
                    {
                        return fmt::format(
                            ...
                            !attributes.empty()
                                ...
                                : "",
                            !run_attribute_names.empty() ? fmt::format("\n\t\"run_attributes\": [\"{}\"],",
                                                                       fmt::join(run_attribute_names, "\", \""))
                                                         : "",
            ...
            */
            ...
            protected:
                ...
                //! Algorithm meta data
                const analyzer::structures::AlgorithmInfo algorithm_;
                ...
                analyzer::structures::Attributes attributes_;
                ...
                virtual void handle_new_problem(const problem::MetaData &problem)
                {
                    ...
                    using sAttr = analyzer::structures::Attribute<str>;
                    ...
                    if (best_points_.evals != 0)
                    {
                        experiments_.at(current_filename_)
                            ...
                            .runs.emplace_back(
                                ...
                                common::as_vector<std::string, double, analyzer::structures::Attribute<double>>(
                                    attributes_.run));
            ...
            public:
                ...
                virtual void attach_problem(const problem::MetaData &problem) override
                {
                    ...
                    best_points_ = {
                        0,
                        std::vector<problem::MultiObjectiveSolution<double>>(
                            1,
                            ioh::problem::MultiObjectiveSolution<double>(
                                std::vector<double>(problem.n_variables),
                ...
                void set_experiment_attributes(const analyzer::structures::StringMap &map)
                {
                ...
                void set_run_attributes(const analyzer::structures::dPtrMap &map)
                {
            ...
            private:
                ...
                static inline ioh::logger::mo::Properties default_properties_mo_{ioh::logger::mo::watch::current_y};
            };
        } // namespace mo
