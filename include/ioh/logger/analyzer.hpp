...
namespace ioh::logger
{
    ...
    private:
        inline watch::Evaluations evaluations_{R"#("function evaluation")#"};
        inline watch::CurrentY current_y_{R"#("current f(x)")#"};
        inline watch::RawYBest y_best_{R"#("best-so-far f(x)")#"};
        inline watch::TransformedY transformed_y_{R"#("current af(x)+b")#"};
        inline watch::TransformedYBest transformed_y_best_{R"#("best af(x)+b")#"};
        inline Properties default_properties_{evaluations_, current_y_, y_best_, transformed_y_,
                                                     transformed_y_best_};
    };
} // namespace ioh::logger
