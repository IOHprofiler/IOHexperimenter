...
namespace ioh
{
    namespace logger
    {
        ...
        {
            //! The current transformed objective function value w.o. contraints.
            std::vector<double> transformed_y;

            //! The current best transformed objective function values w.o. contraints (since the last reset).
            std::vector<std::vector<double>> transformed_y_best;
            ...
            //! Optimal pareto front to the current problem instance, with the corresponding transformed objective
            //! function value.
            std::vector<problem::MultiObjectiveSolution<double>> optima;
        };
        ...
        namespace mo
        {
            ...
            public:
                 ...
                 * @returns An optional that holds a `std::vector<double>` if the variable is available, `std::nullopt`
                 * else.
                 */
                virtual std::optional<std::vector<double>>
                operator()(const logger::MultiObjectiveInfo &log_info) const = 0;
            ...
            namespace watch
            {
                 ...
                 * @ingroup Logging
                 */
                struct TransformedY : public logger::mo::Property
                {
                    //! Constructor.
                    //! Main call interface.
                 ...
                 * @ingroup Logging
                 */
                struct CurrentY : public logger::mo::Property
                {
                    //! Constructor.
                    //! Main call interface.
                    CurrentY(const std::string name = "current_y",
                             const std::string &format = logger::DEFAULT_DOUBLE_FORMAT) :
                        logger::mo::Property(name, format)
                    {
                    }
                 ...
                 *
                 * @warning It is your responsability to ensure that the referenced pointer is a nullptr if the variable
                 * is out of the logged scope.
                 *
                 * @note The pointed variable must be castable to a double.
                 *
                 * @ingroup Logging
