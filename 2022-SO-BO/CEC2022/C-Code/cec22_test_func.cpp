...
int main()
{
    ...
    {
		auto instance = std::make_shared<ioh::problem::cec::HybridFunction2>(1, instance_input.size());
		...
		y=(double *)malloc(sizeof(double)  *  nx);
		z=(double *)malloc(sizeof(double)  *  nx);
		hf10(&instance_input[0], &f, nx, &instance->variables_shift_[0], linear_transformation_raw, &instance->input_permutation_[0], 1, 1);
		free(z);
		free(y);
		f += instance->objective_shift_;
