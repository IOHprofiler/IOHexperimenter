...
class Integer:
    ...
    @property
    def state(self) -> The current state of the problem: ...
...
def wrap_integer_problem(f: Callable[[List[int]],float], : str, n_variables: int = ..., optimization_type: ioh.iohcpp.OptimizationType = ..., constraint: ioh.iohcpp.IntegerConstraint = ...) -> IntegerWrappedProblem: ...
def wrap_real_problem(f: Callable[[List[float]],float], : str, n_variables: int = ..., optimization_type: ioh.iohcpp.OptimizationType = ..., constraint: ioh.iohcpp.RealConstraint = ...) -> RealWrappedProblem: ...
