...
class Analyzer(AbstractWatcher):
    ...
    @overload
    def add_run_attribute(self, arg0: str, arg1: float) -> None: ...
    @overload
    def add_run_attribute(self, arg0: object, arg1: str) -> None: ...
...
class Cursor:
    def __init__(self, arg0: str, arg1: int, arg2: int, arg3: int, arg4: int, arg5: int) -> None: ...
...
class Store(AbstractWatcher):
    def __init__(self, arg0: List[trigger.Trigger], arg1: List[property.AbstractProperty]) -> None: ...
