...
{
    nb::class_<PBO, IntegerSingleObjective>(m, "PBO",
                                                                  R"pbdoc(
    ...
    nb::class_<pbo::OneMax, PBO>(m, "OneMax", nb::is_final(),
                                                               R"pbdoc(
            OneMax:
    ...
    nb::class_<pbo::LeadingOnes, PBO>(m, "LeadingOnes", nb::is_final(),
                                                                         R"pbdoc(
            LeadingOnes:
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::Linear, PBO>(m, "Linear", nb::is_final(),
                                                               R"pbdoc(
            A Linear Function with Harmonic Weights:
            {0,1}^n → ℝ, x ↦ ∑_i i * x_i
        )pbdoc")
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::OneMaxDummy1, PBO>(m, "OneMaxDummy1", nb::is_final(),
                                                                           R"pbdoc(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::OneMaxDummy2, PBO>(m, "OneMaxDummy2", nb::is_final(),
                                                                           R"pbdoc(
                A variant of OneMax applying the Dummy transformation of W-model. m = 0.9n.
                Details can be found in https://doi.org/10.1016/j.asoc.2019.106027.
            )pbdoc")
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::OneMaxNeutrality, PBO>(m, "OneMaxNeutrality",
                                                                                   nb::is_final(),
                                                                                   R"pbdoc(
    ...
    nb::class_<pbo::LeadingOnesDummy1, PBO>(m, "LeadingOnesDummy1",
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::LeadingOnesDummy2, PBO>(m, "LeadingOnesDummy2",
                                                                                     nb::is_final(),
                                                                                     R"pbdoc(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::LeadingOnesNeutrality, PBO>(m, "LeadingOnesNeutrality",
                                                                                             nb::is_final(),
                                                                                             R"pbdoc(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::LeadingOnesEpistasis, PBO>(m, "LeadingOnesEpistasis",
                                                                                           nb::is_final(),
                                                                                           R"pbdoc(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::LeadingOnesRuggedness1, PBO>(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::LeadingOnesRuggedness2, PBO>(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::LeadingOnesRuggedness3, PBO>(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::LABS, PBO>(m, "LABS", nb::is_final(),
                                                           R"pbdoc(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::IsingRing, PBO>(m, "IsingRing", nb::is_final(),
                                                                     R"pbdoc(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::IsingTorus, PBO>(m, "IsingTorus", nb::is_final(),
                                                                       R"pbdoc(
            The Ising Spin Glass model arose in solid-state physics and statistical mechanics, aiming to 
            describe simple interactions within many-particle systems. A compact form used here is 
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::IsingTriangular, PBO>(m, "IsingTriangular", nb::is_final(),
                                                                                 R"pbdoc(
            The Ising Spin Glass model arose in solid-state physics and statistical mechanics, aiming to 
            describe simple interactions within many-particle systems. A compact form used here is 
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::MIS, PBO>(m, "MIS", nb::is_final(),
                                                         R"pbdoc(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::NQueens, PBO>(m, "NQueens", nb::is_final(),
                                                                 R"pbdoc(
        ...
        .def(nb::init<int, int>(), nb::arg("instance"), nb::arg("n_variables"));
    nb::class_<pbo::ConcatenatedTrap, PBO>(m, "ConcatenatedTrap",
                                                                                   nb::is_final(),
                                                                                   R"pbdoc(
...
{
public:
    NB_TRAMPOLINE(WModel, 1);
protected:
    int wmodel_evaluate(const std::vector<int> &x) override { NB_OVERRIDE_PURE(wmodel_evaluate, x); }
};
...
{
    nb::class_<WModel, WModelTrampoline, IntegerSingleObjective>(m, "AbstractWModel",
                                                                                          R"pbdoc(
    ...
    nb::class_<wmodel::WModelLeadingOnes, WModel>(m, "WModelLeadingOnes",
                                                                                              R"pbdoc(
    ...
    nb::class_<wmodel::WModelOneMax, WModel>(m, "WModelOneMax",
                                                                                    R"pbdoc(
...
void define_submodular_problems(nb::module_ &m)
{
    ...
    nb::class_<GraphConstraint, Constraint<int>>(m, "GraphConstraint")
        .def("__repr__", &GraphConstraint::repr);

    nb::class_<pwt::PWTConstraint, Constraint<int>>(m, "PWTConstraint")
    ...
    nb::class_<graph::Graph>(m, "Graph", "Graph data structure")
    ...
    nb::class_<GraphProblem, IntegerSingleObjective>(m, "GraphProblem",
                                                                                    "Graph type problem",
                                                                                    R"pbdoc(
    ...
    nb::class_<MaxCut, GraphProblem>(m, "MaxCut", nb::is_final(), R"pbdoc(
            Max-Cut problems
    ...
    nb::class_<MaxCoverage, GraphProblem>(m, "MaxCoverage", nb::is_final(),
                                                                        R"pbdoc(
    ...
    nb::class_<MaxInfluence, GraphProblem>(m, "MaxInfluence", nb::is_final(),
                                                                          R"pbdoc(
    ...
    nb::class_<PackWhileTravel, GraphProblem>(m, "PackWhileTravel", nb::is_final(),
                                                                                R"pbdoc(
